...
class TestMarkovCodeGuide:
    ...
    def test_suggest_next_nodes_temperature(self, guide):
        ...
        cold_suggestions = guide.suggest_next_nodes(context, temperature=0.0, min_confidence='LOW')
...
class TestEdgeCases:
    ...
    def test_context_to_state_edge_cases(self):
        ...
        assert state == ('FunctionDef', 'FunctionDef', 'If')  # Grandparent defaults to parent
