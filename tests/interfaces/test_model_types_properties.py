...
class TestNextNodeSuggestionProperties:
    ...
    def test_common_patterns_always_list(self, node_type, probability, confidence, common_patterns):
...
class TestASTContextProperties:
    ...
    def test_to_state_returns_strings(self, parent_type, current_node, ancestor_chain, order):
    ...
    def test_to_state_order_subset_property(self, parent_type, current_node, ancestor_chain):
...
class TestCrossModuleProperties:
    ...
    def test_ast_context_state_as_dict_key(self, parent_type, current_node, ancestor_chain):
