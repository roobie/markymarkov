...
class TestASTContext:
    ...
    def test_get_depth(self):
        ...
        ctx2 = ASTContext(
            'FunctionDef', 'If', ancestor_chain=['Module']
        )
        assert ctx2.get_depth() == 2
        
        ctx3 = ASTContext(
            'If', 'Return', ancestor_chain=['Module', 'FunctionDef']
        )
    ...
    def test_repr(self):
        """Test string representation."""
        ctx = ASTContext(
            'FunctionDef', 'If', ancestor_chain=['Module', 'FunctionDef']
        )
        repr_str = repr(ctx)
